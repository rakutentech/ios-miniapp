...
internal enum MiniAppRATEvent: String, CaseIterable {
    ...
    case isDarkMode = "mini_app_is_dark_mode"
    case sendAnalytics = "mini_app_send_ma_analytics"
    case sendInfoToHostApp = "mini_app_send_info_to_host_app"
