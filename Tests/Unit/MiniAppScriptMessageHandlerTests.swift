        ...
        describe("Mini App Script message handler test") {
            ...
            context("when handleBridgeMessage receive invalid action, valid id") {
                it("will return error") {
                    ...
                    let requestParam = RequestParameters(action: "", permission: "location", permissions: nil, locationOptions: nil, shareInfo: ShareInfoParameters(content: ""), adType: 0, adUnitId: "")
