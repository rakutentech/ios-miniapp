...
public protocol ChatMessageBridgeDelegate: class {
    ...
    /// Should invoke completionHandler success after message was successfully sent.
    /// Should invoke completionHandler error when there was an error.
    ...
    /// If the user cancelled sending the message, should invoked completionHandler success with an empty list.
    /// Should invoke completionHandler error when there was an error.
